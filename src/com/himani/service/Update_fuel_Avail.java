...
public class Update_fuel_Avail extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try 
		{
					...
					System.out.println(fdiselqty);
					
					Connection con = ConnectDB.dbCon();
					PreparedStatement ps = con.prepareStatement("update fuelstation set fpetrolqty=?, fdiselqty=? where femail =?");
					ps.setInt(1, Integer.parseInt(fpetrolqty));
					ps.setInt(2, Integer.parseInt(fdiselqty));
