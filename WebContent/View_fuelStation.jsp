...
<div class="container mx-auto mt-8">
  <h1 class="text-center text-3xl font-semibold mb-8 text-gray-800">Fuel Station List</h1>
  <table class="min-w-full border-collapse border border-gray-300">
    <thead class="bg-gray-200">
      <tr>
        ...
        <th class="border px-4 py-2">Petrol Qty</th>
        <th class="border px-4 py-2">Petrol Rate</th>
        <th class="border px-4 py-2">Diesel Qty</th>
